var seckill={
    ...
    URL:{
        now:function() {
            return '/myseckill_war/myseckill/time/now';
        },
        exposer:function(seckillId) {
            return '/myseckill_war/myseckill/'+seckillId+'/exposer';
        },
        execution:function(seckillId,md5) {
            return '/myseckill_war/myseckill/'+seckillId+'/'+md5+'/execution';
        }
    },
    //验证手机号
            ...
            if(!seckill.validatePhone(killPhone)){
                ...
                $('#killPhoneBtn').click(function() {
                    ...
                    if(seckill.validatePhone(inputPhone)){
                        //写入cookie,只对path有效
                        $.cookie('killPhone',inputPhone,{expires:7,path:'/myseckill_war'});
                        //验证通过刷新页面
